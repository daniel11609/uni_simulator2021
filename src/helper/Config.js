export default class Config {
    static rooms = [{id: 1, purchased: true, locked: false, name: "Biology", equipment: 0, capacity: 20, prof: -1},
        ...
        {id: 4, purchased: false, locked: true, name: "Literature", equipment: 0, capacity: 20, prof: -1},
        {id: 5, purchased: false, locked: true, name: "Law", equipment: 0, capacity: 20, prof: -1},
        {id: 6, purchased: false, locked: true, name: "Maths", equipment: 0, capacity: 20, prof: -1},
        {id: 7, purchased: false, locked: true, name: "Mech. Engineering", equipment: 0, capacity: 20, prof: -1},
        {id: 8, purchased: false, locked: true, name: "Music", equipment: 0, capacity: 20, prof: -1},
        {id: 9, purchased: false, locked: true, name: "Sports", equipment: 0, capacity: 20, prof: -1},
        {id: 10, purchased: false, locked: true, name: "History", equipment: 0, capacity: 20, prof: -1},
        {id: 11, purchased: false, locked: true, name: "Geography", equipment: 0, capacity: 20, prof: -1},
        {id: 12, purchased: false, locked: true, name: "Elec. Engineering", equipment: 0, capacity: 20, prof: -1},
        {id: 13, purchased: false, locked: true, name: "Art", equipment: 0, capacity: 20, prof: -1}
        ]
    ...
    static equipmentTime = [{equipment:0, time: 60000},
