export default class Config {
    static rooms = [{id: 1, purchased: true, running: false, starting_time: 0, progress: 0, locked: false, name: "Biology", equipment: 0, capacity: 5, prof: -1},
        {id: 2, purchased: false, running: false, starting_time: 0, progress: 0, locked: false, name: "Computer Science", equipment: 0, capacity: 7, prof: -1},
        {id: 3, purchased: false, running: false, starting_time: 0, progress: 0, locked: false, name: "Chemistry", equipment: 0, capacity: 4, prof: -1},
