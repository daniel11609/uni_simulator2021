export default class Config {
    static rooms = [{id: 1, purchased: true, running: false, starting_time: 0, progress: 0, locked: false, name: "Biology", equipment: 0, capacity: 20, prof: -1},
        ...
        {id: 6, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Maths", equipment: 0, capacity: 20, prof: -1, price:400},
        {id: 7, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Mech. Engineering", equipment: 0, capacity: 20, prof: -1, price:800},
        {id: 8, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Music", equipment: 0, capacity: 20, prof: -1, price:1600},
        {id: 9, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Sports", equipment: 0, capacity: 20, prof: -1, price:3200},
        {id: 10, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "History", equipment: 0, capacity: 20, prof: -1, price:6400},
        {id: 11, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Geography", equipment: 0, capacity: 20, prof: -1, price:12800},
        {id: 12, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Elec. Engineering", equipment: 0, capacity: 20, prof: -1, price:25600},
        {id: 13, purchased: false, running: false, starting_time: 0, progress: 0, locked: true, name: "Art", equipment: 0, capacity: 20, prof: -1, price:51200}
        ]
